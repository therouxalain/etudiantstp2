    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('article.create') }}" method="post">
                ...
                <br>
                <input type="text" class="form-control" name="title" id="title" placeholder="@lang('lang.title')">
                @if ($errors->has('title'))
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul>
                        ...
                        <li class="mt-2">
                            <a href="{{ route('article.show', $article->id) }}">{{ $article->title }}</a> | @lang('lang.date_input') {{ $article->created_at }} 
                        </li>
                        @endif
                        @empty
                ...
                {{--  {{ $pagination->links('layout.pagination') }} à compléter --}}
            </div>
        </div>
    </div>
</div>
